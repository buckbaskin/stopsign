...
if __name__ == '__main__':
    ...
    Klassifier_configs = [{}]
    # Klassifier_configs.extend(make_all_combinations(kn_spec))
        ...
        for index, Klassifier in enumerate(Klassifiers):
            ...
            for config_setup in Klassifier_configs:
                ...
                for seed in range(0, num_tests):
                    ...
                    #     random_state=rng,
                    #     **ensemble_spec)
                    clf1 = MLPRegressor(**mlp_spec)
                    clf2 = SGDRegressor(**sgd_spec)
                    clf3 = AdaBoostRegressor(
                        base_estimator=DecisionTreeClassifier(**bdt_spec),
                        **ensemble_spec
                    )
